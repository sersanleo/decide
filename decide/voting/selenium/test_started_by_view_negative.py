...
class TestStartedByViewNegative(StaticLiveServerTestCase):
  def setUp(self):
  ...
  def test_started_by_view_negative(self):
    ...
    self.driver.find_element(By.ID, "id_name").send_keys("pruebastarted")
    # 5 | type | id=id_desc | prueba
    self.driver.find_element(By.ID, "id_desc").send_keys("pruebastarted")
    ...
    text = self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-started_by").text
    assert text != "decide"
